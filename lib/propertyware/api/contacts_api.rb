...
module Propertyware
  class ContactsApi
    ...
    # @param [Hash] opts the optional parameters
    # @return [Contact]
    def update_contact(contact_id, save_contact, opts = {})
      data, _status_code, _headers = update_contact_with_http_info(contact_id, save_contact, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Contact, Integer, Hash)>] Contact data, response status code and response headers
    def update_contact_with_http_info(contact_id, save_contact, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'save_contact' is set
      if @api_client.config.client_side_validation && save_contact.nil?
        fail ArgumentError, "Missing the required parameter 'save_contact' when calling ContactsApi.update_contact"
      end
      # resource path
      local_var_path = '/contacts/{contactID}'.sub('{' + 'contactID' + '}', CGI.escape(contact_id.to_s))
