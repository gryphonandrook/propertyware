...
module Propertyware
  # Management Fee
  class ManagementFee
    # Management fee account code.
    attr_accessor :account_code

    # Management fee account number.
    ...
    # Property manager commission percentage.
    attr_accessor :managers_commission_percentage

    # Indicates if the commission account is of the passthrough type.
    ...
    def self.attribute_map
      {
        ...
        :'id' => :'id',
        :'manager' => :'manager',
        :'managers_commission_percentage' => :'managersCommissionPercentage',
    ...
    def self.openapi_types
      {
        ...
        :'id' => :'Integer',
        :'manager' => :'String',
        :'managers_commission_percentage' => :'Float',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::ManagementFee` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::ManagementFee`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'managers_commission_percentage')
        self.managers_commission_percentage = attributes[:'managers_commission_percentage']
      end

      if attributes.key?(:'pass_through')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          id == o.id &&
          manager == o.manager &&
          managers_commission_percentage == o.managers_commission_percentage &&
    ...
    def hash
      [account_code, account_number, id, manager, managers_commission_percentage, pass_through, percentage].hash
    end
