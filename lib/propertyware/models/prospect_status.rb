...
module Propertyware
  ...
  class ProspectStatus
    ...
    # Status visible On Portal
    attr_accessor :visible_on_portal
    ...
    def self.attribute_map
      {
        ...
        :'readonly' => :'readonly',
        :'status' => :'status',
        :'visible_on_portal' => :'visibleOnPortal'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::ProspectStatus` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::ProspectStatus`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'visible_on_portal')
        self.visible_on_portal = attributes[:'visible_on_portal']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          readonly == o.readonly &&
          status == o.status &&
          visible_on_portal == o.visible_on_portal
    end
    ...
    def hash
      [id, readonly, status, visible_on_portal].hash
    end
