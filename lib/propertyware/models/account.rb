...
module Propertyware
  ...
  class Account
    ...
    def hash
      [account_code, account_number, account_type, active, auto_apply_prepayment, bank_account_holder, bank_account_number, bank_address, bank_address2, bank_city, bank_institution, bank_routing_number, bank_state, bank_zip, cam_recovery_account, created_by, created_date_time, discount_account, escrow_account, exclude_from1099, exclude_from_pay_in_full, exclude_late_fee, id, last_modified_by, last_modified_date_time, late_fee_applicable, name, parent_gl_account_id, parent_ref, payment_priority, rent_account, section8, tax_account, transfer_balance_to_retained_earnings].hash
    end
