...
module Propertyware
  ...
  class SaveBankDeposit
    ...
    attr_accessor :list_of_tx_ids

    # Attribute mapping from ruby-style variable name to JSON key.
    def self.attribute_map
      {
        :'bank_gl_account_id' => :'bankGLAccountID',
        :'list_of_tx_ids' => :'listOfTxIDs'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::SaveBankDeposit` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::SaveBankDeposit`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'list_of_tx_ids')
        self.list_of_tx_ids = attributes[:'list_of_tx_ids']
      end
    end
    ...
    def list_invalid_properties
      ...
      if @bank_gl_account_id.nil?
        invalid_properties.push('invalid value for "bank_gl_account_id", bank_gl_account_id cannot be nil.')
      end

      if @list_of_tx_ids.nil?
        invalid_properties.push('invalid value for "list_of_tx_ids", list_of_tx_ids cannot be nil.')
      end
    ...
    def valid?
      return false if @bank_gl_account_id.nil?
      return false if @list_of_tx_ids.nil?
      true
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          list_of_tx_ids == o.list_of_tx_ids
    end
    ...
    def hash
      [bank_gl_account_id, list_of_tx_ids].hash
    end
