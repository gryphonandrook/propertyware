...
module Propertyware
  ...
  class Bill
    ...
    # Indicates if the bill is a credit.
    ...
    # The ID of the general ledger account associated with the markup.
    attr_accessor :markup_gl_account_id

    # The markup percentage.
    attr_accessor :markup_percentage

    # Indicates if the bill is an owner draw.
    ...
    def hash
      [bill_date, bill_number, bill_splits, comments, created_by, created_date_time, credit, due_date, id, last_modified_by, last_modified_date_time, markup_gl_account_id, markup_percentage, owner_draw, payment_date, ref_no, terms, vendor_id, work_order_id].hash
    end
