...
module Propertyware
  ...
  class SaveLease
    ...
    def hash
      [comments, end_date, leasing_fee_amount, leasing_fee_date, leasing_fee_ref_no, move_in_date, move_out_date, post_first_charge, primary_contact_id, prorate_month, rent_auto_charge, sec_dep_amount, sec_dep_charge_date, start_date, status, tenant_ids, unit_id].hash
    end
