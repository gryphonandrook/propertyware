...
module Propertyware
  ...
  class Payment
    ...
    def hash
      [amount, comments, contact_id, created_by, created_date_time, date, deposit_date, destination_account_id, id, is_deposited, last_modified_by, last_modified_date_time, lease_id, payment_type, portfolio_id, ref_no, status].hash
    end
