...
module Propertyware
  ...
  class Lease
    ...
    def hash
      [active, addendums, building_id, comments, contacts, created_by, created_date_time, custom_fields, end_date, id, id_number, last_modified_by, last_modified_date_time, late_fee_rule, lease_balance, lease_name, location, move_in_date, move_out_date, notice_given_date, payment_restriction, portfolio_id, public_assistance_program, reason_for_leaving, schedule_move_out_date, start_date, status, tenants_opts_into_asset_protection_plan, terminated_date, unit_id].hash
    end
