...
module Propertyware
  class SplitPaid
    ...
    # Total amount paid for this line item.
    attr_accessor :amount_paid

    # Amount that was paid in this payment.
    attr_accessor :amount_paid_by_bill_payment

    # Id of the building associated with this line item.
    ...
    # Indicates if this line item is paid.
    attr_accessor :paid

    # Id of the portfolio associated with this line item.
    attr_accessor :portfolio_id

    # Id of the unit associated with this line item.
    ...
    def self.attribute_map
      {
        ...
        :'amount_paid_by_bill_payment' => :'amountPaidByBillPayment',
    ...
    def self.openapi_types
      {
        :'amount' => :'Float',
        :'amount_paid' => :'Float',
        :'amount_paid_by_bill_payment' => :'Float',
        :'building_id' => :'Integer',
        :'comments' => :'String',
        :'id' => :'Integer',
        :'paid' => :'Boolean',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::SplitPaid` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::SplitPaid`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'amount_paid_by_bill_payment')
        self.amount_paid_by_bill_payment = attributes[:'amount_paid_by_bill_payment']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          amount_paid_by_bill_payment == o.amount_paid_by_bill_payment &&
    ...
    def hash
      [amount, amount_paid, amount_paid_by_bill_payment, building_id, comments, id, paid, portfolio_id, unit_id].hash
    end
