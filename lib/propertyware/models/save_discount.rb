  ...
  class SaveDiscount
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::SaveDiscount` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::SaveDiscount`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'discount_account_id')
        self.discount_account_id = attributes[:'discount_account_id']
      end
    ...
    def list_invalid_properties
      ...
      if @discount_account_id.nil?
        invalid_properties.push('invalid value for "discount_account_id", discount_account_id cannot be nil.')
      end
    ...
    def valid?
      ...
      return false if @discount_account_id.nil?
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          comments == o.comments &&
          date == o.date &&
          discount_account_id == o.discount_account_id &&
          lease_id == o.lease_id &&
          ref_no == o.ref_no
    end
    ...
    def hash
      [amount, comments, date, discount_account_id, lease_id, ref_no].hash
    end
