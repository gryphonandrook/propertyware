...
module Propertyware
  ...
  class ManagementSettings
    ...
    # Indicates the type of management fee.
    attr_accessor :management_fee_type

    # List of property management fee rules.
    attr_accessor :management_fees
    ...
    def self.openapi_types
      {
        ...
        :'management_fees' => :'Array<ManagementFee>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::ManagementSettings` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::ManagementSettings`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'management_fees')
        if (value = attributes[:'management_fees']).is_a?(Array)
          self.management_fees = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          management_fees == o.management_fees &&
    ...
    def hash
      [management_contract_end_date, management_contract_start_date, management_fee_type, management_fees, management_flat_fee].hash
    end
