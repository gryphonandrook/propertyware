...
module Propertyware
  class Document
    ...
    attr_accessor :indicates_if_publish_to_owner_portal

    # Indicates if the document is published to the tenant portal.
    attr_accessor :indicates_if_publish_to_tenant_portal
    ...
    def self.attribute_map
      {
        ...
        :'filename' => :'filename',
        :'id' => :'id',
        :'indicates_if_publish_to_owner_portal' => :'indicatesIfPublishToOwnerPortal',
        :'indicates_if_publish_to_tenant_portal' => :'indicatesIfPublishToTenantPortal',
    ...
    def self.openapi_types
      {
        ...
        :'filename' => :'String',
        :'id' => :'Integer',
        :'indicates_if_publish_to_owner_portal' => :'Boolean',
        :'indicates_if_publish_to_tenant_portal' => :'Boolean',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'indicates_if_publish_to_owner_portal')
        self.indicates_if_publish_to_owner_portal = attributes[:'indicates_if_publish_to_owner_portal']
      end

      if attributes.key?(:'indicates_if_publish_to_tenant_portal')
        self.indicates_if_publish_to_tenant_portal = attributes[:'indicates_if_publish_to_tenant_portal']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          filename == o.filename &&
          id == o.id &&
          indicates_if_publish_to_owner_portal == o.indicates_if_publish_to_owner_portal &&
          indicates_if_publish_to_tenant_portal == o.indicates_if_publish_to_tenant_portal &&
    ...
    def hash
      [created_by, created_date_time, description, entity_id, entity_type, file_type, filename, id, indicates_if_publish_to_owner_portal, indicates_if_publish_to_tenant_portal, last_modified_by, last_modified_date_time].hash
    end
