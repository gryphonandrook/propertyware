...
module Propertyware
  ...
  class JournalEntry
    ...
    # List of journal entry splits.
    attr_accessor :journal_entry_split
    ...
    # Id of the lease associated with this journal entry.
    ...
    def self.attribute_map
      {
        ...
        :'date' => :'date',
        :'id' => :'id',
        :'journal_entry_split' => :'journalEntrySplit',
    ...
    def self.openapi_types
      {
        ...
        :'date' => :'String',
        :'id' => :'Integer',
        :'journal_entry_split' => :'Array<JournalEntrySplitResponse>',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::JournalEntry` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::JournalEntry`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'journal_entry_split')
        if (value = attributes[:'journal_entry_split']).is_a?(Array)
          self.journal_entry_split = value
        end
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          date == o.date &&
          id == o.id &&
          journal_entry_split == o.journal_entry_split &&
    ...
    def hash
      [comments, created_by, created_date_time, date, id, journal_entry_split, last_modified_by, last_modified_date_time, lease_id, ref_no].hash
    end
