...
module Propertyware
  ...
  class CampaignSource
    # Call tracking group id.
    attr_accessor :call_tracking_group_id
    ...
    def self.attribute_map
      {
        :'call_tracking_group_id' => :'callTrackingGroupID',
        :'default' => :'default',
        :'id' => :'id',
        :'name' => :'name',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Propertyware::CampaignSource` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Propertyware::CampaignSource`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'call_tracking_group_id')
        self.call_tracking_group_id = attributes[:'call_tracking_group_id']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          call_tracking_group_id == o.call_tracking_group_id &&
          default == o.default &&
          id == o.id &&
          name == o.name &&
    ...
    def hash
      [call_tracking_group_id, default, id, name, referrer_domain].hash
    end
