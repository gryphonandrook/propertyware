...
module Propertyware
  ...
  class SaveAccount
    ...
    attr_accessor :non_operating_inome
    ...
    def self.attribute_map
      {
        ...
        :'non_operating_inome' => :'nonOperatingInome',
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'non_operating_inome')
        self.non_operating_inome = attributes[:'non_operating_inome']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          non_operating_inome == o.non_operating_inome &&
    ...
    def hash
      [account_number, account_type, auto_apply_prepayment, bank, code, credit_card, current_asset, current_liability, description, equity, expense, income, non_current_asset, non_current_liability, non_operating_expense, non_operating_inome, parent_gl_account_id, taxable].hash
    end
