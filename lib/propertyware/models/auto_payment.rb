...
module Propertyware
  class AutoPayment
    ...
    def hash
      [account, amount, created_by, created_date_time, description, end_date, fee_amount, frequency, id, last_modified_by, last_modified_date_time, last_post_date, start_date].hash
    end
