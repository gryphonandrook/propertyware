...
```shell
gem install ./propertyware-1.0.1.gem
```

(for development, run `gem install --dev ./propertyware-1.0.1.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'propertyware', '~> 1.0.1'
...
- **Type**: API key
- **API key parameter name**: x-propertyware-organization-id
- **Location**: HTTP header
