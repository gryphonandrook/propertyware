...
```shell
gem install ./propertyware-1.0.4.gem
```

(for development, run `gem install --dev ./propertyware-1.0.4.gem` to install the development dependencies)

or publish the gem to a gem hosting service, e.g. [RubyGems](https://rubygems.org/).

Finally add this to the Gemfile:

    gem 'propertyware', '~> 1.0.4'
