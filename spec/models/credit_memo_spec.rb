...
# Unit tests for Propertyware::CreditMemo
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::CreditMemo do
  let(:instance) { Propertyware::CreditMemo.new }

  describe 'test an instance of CreditMemo' do
    it 'should create an instance of CreditMemo' do
      expect(instance).to be_instance_of(Propertyware::CreditMemo)
    end
  end
