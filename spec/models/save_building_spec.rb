...
# Unit tests for Propertyware::SaveBuilding
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::SaveBuilding do
  let(:instance) { Propertyware::SaveBuilding.new }

  describe 'test an instance of SaveBuilding' do
    it 'should create an instance of SaveBuilding' do
      expect(instance).to be_instance_of(Propertyware::SaveBuilding)
    end
  end
  ...
  describe 'test attribute "year_built_as_string"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
