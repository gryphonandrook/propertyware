...
# Unit tests for Propertyware::Owner
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::Owner do
  let(:instance) { Propertyware::Owner.new }

  describe 'test an instance of Owner' do
    it 'should create an instance of Owner' do
      expect(instance).to be_instance_of(Propertyware::Owner)
    end
  end
