...
# Unit tests for Propertyware::OwnerContribution
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::OwnerContribution do
  let(:instance) { Propertyware::OwnerContribution.new }

  describe 'test an instance of OwnerContribution' do
    it 'should create an instance of OwnerContribution' do
      expect(instance).to be_instance_of(Propertyware::OwnerContribution)
    end
  end
