...
# Unit tests for Propertyware::Refund
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::Refund do
  let(:instance) { Propertyware::Refund.new }

  describe 'test an instance of Refund' do
    it 'should create an instance of Refund' do
      expect(instance).to be_instance_of(Propertyware::Refund)
    end
  end
