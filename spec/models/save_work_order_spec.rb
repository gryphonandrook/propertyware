...
# Unit tests for Propertyware::SaveWorkOrder
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::SaveWorkOrder do
  let(:instance) { Propertyware::SaveWorkOrder.new }

  describe 'test an instance of SaveWorkOrder' do
    it 'should create an instance of SaveWorkOrder' do
      expect(instance).to be_instance_of(Propertyware::SaveWorkOrder)
    end
  end
  ...
  describe 'test attribute "hour_to_enter"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  describe 'test attribute "minute_to_enter"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
