...
# Unit tests for Propertyware::SaveBill
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::SaveBill do
  let(:instance) { Propertyware::SaveBill.new }

  describe 'test an instance of SaveBill' do
    it 'should create an instance of SaveBill' do
      expect(instance).to be_instance_of(Propertyware::SaveBill)
    end
  end
  ...
  describe 'test attribute "owner_draw"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
