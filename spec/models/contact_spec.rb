...
# Unit tests for Propertyware::Contact
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::Contact do
  let(:instance) { Propertyware::Contact.new }

  describe 'test an instance of Contact' do
    it 'should create an instance of Contact' do
      expect(instance).to be_instance_of(Propertyware::Contact)
    end
  end
  ...
  describe 'test attribute "type"' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["TENANT", "PROSPECT", "OWNER", "VENDOR", "OTHER"])
      # validator.allowable_values.each do |value|
