...
# Unit tests for Propertyware::AutoPayment
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Propertyware::AutoPayment do
  let(:instance) { Propertyware::AutoPayment.new }

  describe 'test an instance of AutoPayment' do
    it 'should create an instance of AutoPayment' do
      expect(instance).to be_instance_of(Propertyware::AutoPayment)
    end
  end
