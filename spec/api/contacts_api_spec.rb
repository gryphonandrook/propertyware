...
# Unit tests for Propertyware::ContactsApi
...
describe 'ContactsApi' do
  ...
  describe 'test an instance of ContactsApi' do
    it 'should create an instance of ContactsApi' do
      expect(@api_instance).to be_instance_of(Propertyware::ContactsApi)
    end
  end
  ...
  # @param save_contact saveContact
  ...
  # unit tests for create_contacts_using_post1
  ...
  describe 'create_contacts_using_post1 test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # unit tests for delete_contact_conversation
  ...
  # @param [Hash] opts the optional parameters
  # @return [ResponseEntity]
  describe 'delete_contact_conversation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param [Hash] opts the optional parameters
  # @return [Conversation]
  describe 'get_contact_conversation test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end

  # unit tests for get_contact_conversations
  ...
  describe 'get_contact_conversations test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
